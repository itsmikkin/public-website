        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div className="glass rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
              <h3 className="text-2xl font-medium mb-6 font-poppins">Our Information</h3>
            ...
            <div className="glass rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-2xl font-medium mb-6 font-poppins">Send us a message</h3>

              <form
                action="https://formspree.io/f/xkgreqrp"
                method="POST"
                className="space-y-6"
              >
                <div>
            ...
            <Accordion type="single" collapsible className="w-full">
              {faqs.map((faq, index) => (
                <AccordionItem key={index} value={`item-${index}`} className="border-b border-border/60 last:border-0">
                  <AccordionTrigger className="text-left py-4 hover:text-primary transition-colors text-base">
                    {faq.question}
                  </AccordionTrigger>
                  <AccordionContent className="animate-accordion-down">
                    <p className="text-muted-foreground text-sm py-2 px-1">{faq.answer}</p>
                  </AccordionContent>
                </AccordionItem>
              ))}
            </Accordion>
